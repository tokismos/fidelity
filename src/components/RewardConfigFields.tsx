...
type FormDataProps = Omit<Reward, 'storeId' | 'status'> & {
  image?: string | null;
};

type SetFormDataFunction = (
  updater: (prev: FormDataProps) => FormDataProps
) => void;
type Props = {
  type: REWARD_TYPES;
      ...
      return (
        <>
          <FormField
            ...
            value={(
              formData.config as BuyNGet1Config
            ).required_purchases?.toString()}
            onChangeText={(value) =>
              setFormData((prev) => ({
                ...prev,
      ...
      return (
        <>
          <FormField
            ...
            value={(
              formData.config as DiscountPercentageConfig
      ...
      return (
        <>
          <FormField
            ...
            value={(
              formData.config as DiscountFixConfig
      ...
      return (
        <>
          ...
          <FormField
            label='Points Needed'
            value={(
              formData.config as FreeItemConfig
            ).points_needed_value?.toString()}
            onChangeText={(value) =>
              setFormData((prev) => ({
                ...prev,
      ...
      return (
        <>
          <FormField
            ...
            value={(
              formData.config as FreeItemWithPurchaseConfig
            ).item_name?.toString()}
            onChangeText={(value) =>
              setFormData((prev) => ({
                ...prev,
